  ...
  return (
    <div className="w-full bg-[#F5F5F5] overflow-hidden text-black">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-12 py-16 flex flex-col items-center bg-[#F5F5F5]">
        ...
        <p className="text-xs sm:text-sm max-w-[800px] py-4 px-2 text-gray-600 mt-3 text-center leading-relaxed">
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum voluptatibus quod sequi laudantium aliquid hic odit consectetur facilis reiciendis voluptas omnis libero odio voluptatem cumque maiores reprehenderit, at ipsam dolor.
        </p>
